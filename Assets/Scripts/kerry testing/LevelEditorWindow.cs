...
public class LevelEditorWindow : EditorWindow {
    ...
    private void OnGUI() {
        ...
        // ---------------------- LEFT SIDE ----------------------
        EditorGUILayout.BeginVertical(GUILayout.ExpandWidth(true)); // Left = all editor UI
        ...
        if (levelData == null) {
            ...
            EditorGUILayout.EndVertical(); // left side vertical
            EditorGUILayout.EndHorizontal(); // top-level horizontal
            return;
        }
        ...
        // Optional: grid offset visualization
        GUI.Button(new Rect(gridOffset.x - 5, gridOffset.y - 5, 10, 10), "");

        DrawClearButton();

        EditorGUILayout.EndScrollView();
        EditorGUILayout.EndVertical(); // End LEFT side

        // ---------------------- RIGHT SIDE ----------------------
        EditorGUILayout.BeginVertical(GUILayout.Width(300)); // Right = Controls panel
        ...
        EditorGUILayout.EndHorizontal(); // End top-level horizontal
    }
